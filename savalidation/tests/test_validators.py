...
class TestValidators(object):
    ...
    def test_min_length(self):
        ...
        try:
            ...
            ex.sess.rollback()
            expect = {'minlen': ['Enter a value at least 20 characters long']}
    ...
    def test_ip_addr(self):
        ...
        try:
            ...
            ex.sess.rollback()
            expect = {'ipaddr': ['Please enter a valid IP address (a.b.c.d)']}
            eq_(e.invalid_instances[0].validation_errors, expect)
    ...
    def test_url(self):
        ...
        try:
            ...
            ex.sess.rollback()
            expect = {'url': ['You must provide a full domain name (like foobar.com)']}
            eq_(e.invalid_instances[0].validation_errors, expect)
        ...
        try:
            ...
            ex.sess.rollback()
            expect = {'url': ['That is not a valid URL']}
            eq_(e.invalid_instances[0].validation_errors, expect)
